...
public class Data {
    ...
    Scanner sc = new Scanner(new File("App/FantasyGolf/src/main/resources/teams.csv"));sc.useDelimiter(",");

    List<List<String>> entries = new LinkedList<>();for(
    int teams = 0;teams<numTeams;teams++)
    {
